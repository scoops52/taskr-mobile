        ...
        <View style={styles.modal}>
          <View style={styles.container}>
            ...
            <View style={styles.optionsContainer}>
              ...
              <Pressable onPress={handleEdit} style={({pressed}) =>
               [styles.submit, pressed && styles.submitPressed]}>
                <Text style={styles.submitText}>Update Task</Text>
              </Pressable>
              <Pressable onPress={handleRemove} style={({pressed}) =>
               [styles.submit, pressed && styles.submitPressed, { backgroundColor: '#b80c09'}]}>
